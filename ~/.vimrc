...
Plug 'vim-scripts/Auto-Pairs'             " Autocomplete parens/quotes/brackets
Plug 'rking/ag.vim'                       " the_silver_searcher
Plug 'VundleVim/Vundle.vim'
Plug 'scrooloose/syntastic'               " Syntastic for syntax checking
Plug 'Yggdroot/indentLine'                " Vertical lines showing indentation
...
"这是vundle本身的设置
 ...
 " My Bundles here:
 "这里是设置你自己自定义的插件的设置vundle设置，注意:下载的插件git为:https://github.com/godlygeek/tabular.git，则设置为Plug 'godlygeek/tabular';https://github.com/gmarik/vundle.git设置则为 Plug 'gmarik/vundle'
...
let l = l + 1 | call setline(l,'//@Created by FallCicada')
let l = l + 1 | call setline(l,'//Created Time :'.strftime('%c'))
let l = l + 1 | call setline(l,'//@File Name :'.expand('%'))
let l = l + 1 | call setline(l,'//@Slogan: 無限進步')
let l = l + 1 | call setline(l,'//-------------------------------------------------')
let l = l + 1 | call setline(l,'')
